...
const EventForm = () => {
    ...
    const deleteAllOperaitonLogs = e => {
        e.preventDefault()
    ...
    return (
        ...
        <h4>イベント作成フォーム</h4>
            ...
            <button className="btn btn-danger" onClick={deleteAllOperaitonLogs} disabled={state.operationLogs.length === 0}>全ての操作ログを削除する</button>
        </form>
        </>
    )
}
